  ...
  return (
    <form action={formAction} className='space-y-6'>
        ...
        <div>
            ...
            <input type="text" name="name" placeholder="Asep" className='bg-gray-50 border border-gray-300 text-gray-900 rounded-lg w-full p-2.5'/>
        ...
        <div>
            ...
            <input type="email" name="email" placeholder="Asep@gmail.com" className='bg-gray-50 border border-gray-300 text-gray-900 rounded-lg w-full p-2.5'/>
            <div aria-live='polite' aria-atomic="true">
        ...
        <p className="text-sm font-light text-gray-500">Already have an account
            <Link href="/login"><span className="font-medium pl-1 text-blue-600">Sign In</span></Link>
        </p>
    </form>
  )
}
